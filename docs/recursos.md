...
> Colección curada de recursos para seguir aprendiendo. Cada módulo tiene sus propios enlaces "Para profundizar"; aquí encontrarás recursos transversales que complementan el curso completo.
...
## AI coding assistants y MCP

| Tipo | Recurso | Descripción |
|------|---------|-------------|
| Docs | [Claude Code: Anthropic](https://code.claude.com/docs/en/overview) | AI coding assistant que escribe y ejecuta código autónomamente |
...
## Automatización y herramientas no-code
...
## Privacidad, gobernanza y evaluación
...
| Artículo | [Scaling AI With Adaptive Governance: MIT Sloan](https://sloanreview.mit.edu/article/scaling-ai-with-adaptive-governance/) | Cómo gobernar el riesgo de la IA sin frenar su adopción a escala de organización |
...
| Newsletter | [TheWhiteBox: Ignacio de Gregorio](https://thewhitebox.beehiiv.com/) | Newsletter semanal en inglés que explica la actualidad de la IA desde los fundamentos |
...
| Podcast | [monos estocásticos](https://podcasts.apple.com/es/podcast/monos-estoc%C3%A1sticos/id1665476262) | Podcast semanal de Antonio Ortiz y Matías S. Zavia sobre la actualidad de la IA, en español llano |

---

## Entorno de desarrollo (para módulo 5)
